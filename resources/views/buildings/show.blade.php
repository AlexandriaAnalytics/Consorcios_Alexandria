            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card text-center">
                    	<img style="height: 200px; width: 200px; background-color: #EFEFEF" class="card-img-top rounded-circle float-left mx-auto d-block" src="/images/{{$building->avatar}}">
                        <div class="card-body">
                    		<div class="card-title"><h1 class="m-0 text-dark">Edificio {{$building->name}}</h1></div>
                            ...
                            <a href="/buildings/{{$building->slug}}/edit" class="btn btn-success">Editar</a>
